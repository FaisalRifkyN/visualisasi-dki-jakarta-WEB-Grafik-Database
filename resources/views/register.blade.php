                ...
                <div class="row justify-content-center">
                    <div class="col-lg-5 text-center mx-auto">
                        ...
                        <p class="text-lead text-white">
                            Gunakan formulir luar biasa ini untuk masuk atau membuat akun
                            baru Anda secara gratis.
                        </p>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card z-index-0">
                        ...
                        <div class="card-body">
                            <form action="{{route('actionregister')}}" method="post">
                                ...
                                @endif
                                <div class="mb-3">
                                    <input name="username" type="text" id="username" placeholder="Username" class="form-control" value="{{ old('username') }}" />
                                </div>
                                <div class="mb-3">
                                    <input name="email" type="email" id="email" placeholder="Email" class="form-control" value="{{ old('email') }}" />
                                </div>
                                <div class="mb-3">
